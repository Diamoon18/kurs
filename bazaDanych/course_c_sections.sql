...
DROP TABLE IF EXISTS `c_sections`;
...
CREATE TABLE `c_sections` (
  ...
  KEY `fk_c_sections_c_blocks1_idx` (`c_blocks_block_id`),
  CONSTRAINT `fk_c_sections_c_blocks1` FOREIGN KEY (`c_blocks_block_id`) REFERENCES `c_blocks` (`block_id`)
...
LOCK TABLES `c_sections` WRITE;
/*!40000 ALTER TABLE `c_sections` DISABLE KEYS */;
/*!40000 ALTER TABLE `c_sections` ENABLE KEYS */;
UNLOCK TABLES;
