...
CREATE TABLE `c_questions` (
  ...
  `answer` varchar(150) COLLATE utf8mb3_polish_ci NOT NULL,
  `c_tests_test_id` int NOT NULL,
  PRIMARY KEY (`question_id`),
  KEY `fk_c_questions_c_tests1_idx` (`c_tests_test_id`),
  CONSTRAINT `fk_c_questions_c_tests1` FOREIGN KEY (`c_tests_test_id`) REFERENCES `c_tests` (`test_id`)
